...
tibble(subject = c("Yao", "Emma", "Cassidy", "Tahmid", "Diego"),
       ytreat = c("13", "11", "$$10 + (+1)$$", "$$12 + (-2.5)$$", "6"),
       ycontrol = c("$$13 - (-2.5)$$", "$$11 - (+1)$$", "10", "12", "$$6 - (-2.5)$$"),
       ydiff = c("-2.5", "+1", "+1", "-2.5", "-2.5")) %>%
...
The fundamental components of every problem in causal inference are units, treatments and outcomes. The units are the rows in the tibble. The treatments are the columns. The outcomes are the values.
...
<!-- DK: More meat? Check the first few questions in the tutorial. -->
