...
Save the `.gitignore` file and you should see the `productivity.Rproj` file disappear from your Git tab in the top right window. If you don't see any changes, click on the refresh button in the upper right. 
